...
Release tags and binaries are signed with the GPG key `740FC947B135E7627D4D00F21996B89DF018DCAB` (expiring July 2030). You can obtain this key from `keyserver.ubuntu.com`, from [our website](/pubkey.txt), or from [GitHub](https://github.com/slingamn.gpg).
